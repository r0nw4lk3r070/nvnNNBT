...
- `read_file` — read source material, voice profiles, and existing content
- `write_file` — create content drafts and campaign assets
- `edit_file` — revise existing content
- `web_search` — research topics, find reference content, check competitor posts
- `web_fetch` — read full content from reference URLs
...
- `seo` for keyword and search visibility optimization
- `market-research` for competitive content analysis