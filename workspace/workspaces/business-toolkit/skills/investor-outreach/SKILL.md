...
- `read_file` — read existing voice profiles, investor research, and outreach templates
- `write_file` — create outreach drafts and sequences
- `edit_file` — revise outreach copy
- `web_search` — research investor thesis, portfolio, and recent activity for personalization
...
If the user's voice matters, run the `brand-voice` skill first and reuse its `VOICE PROFILE`.
