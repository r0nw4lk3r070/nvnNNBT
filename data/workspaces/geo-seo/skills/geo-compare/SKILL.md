...
/geo compare workspace/prospects/audits/electron-srl.com-2026-01-15.md workspace/prospects/audits/electron-srl.com-2026-03-12.md
```
...
1. Look in `workspace/prospects/audits/` for files matching `<domain>-*.md`
2. Sort by date
...
Output to `workspace/prospects/reports/<domain>-monthly-<date>.md`
...
1. Save report to `workspace/prospects/reports/<domain>-monthly-<YYYY-MM>.md`
2. Print confirmation with key stats:
   ```
   ✓ Monthly report generated: workspace/prospects/reports/electron-srl.com-monthly-2026-03.md
