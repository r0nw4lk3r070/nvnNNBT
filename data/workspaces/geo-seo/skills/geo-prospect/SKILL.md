...
All data is stored in `workspace/prospects/prospects.json` (persistent across sessions).
...
```json
{
  ...
  "audit_file": "workspace/prospects/audits/electron-srl.com-2026-03-12.md",
  "proposal_file": "workspace/prospects/proposals/electron-srl.com-proposal.md",
  "monthly_value": 0,
  "contract_start": null,
  "contract_months": 0,
  "notes": [
...
1. Check if `workspace/prospects/prospects.json` exists, create if not (empty array)
...
Read `workspace/prospects/prospects.json` and render a summary table:
...
3. Save audit output to `workspace/prospects/audits/<domain>-<date>.md`
...
All data stored in `workspace/prospects/`:
```
workspace/prospects/
...
Create directory if it does not exist: `mkdir -p workspace/prospects/audits workspace/prospects/proposals`
