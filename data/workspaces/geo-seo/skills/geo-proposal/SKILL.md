...
/geo proposal workspace/prospects/audits/electron-srl.com-2026-03-12.md
```
...
1. Check if `workspace/prospects/audits/<domain>*.md` exists
...
Output to `workspace/prospects/proposals/<domain>-proposal-<date>.md`
Also update prospect record if it exists in `workspace/prospects/prospects.json`
...
1. Save proposal to `workspace/prospects/proposals/<domain>-proposal-<date>.md`
2. Update prospect record: set `status` to `proposal`, save `proposal_file` path
3. Print confirmation:
   ```
   ✓ Proposal generated: workspace/prospects/proposals/electron-srl.com-proposal-2026-03-12.md
