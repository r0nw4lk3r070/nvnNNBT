...
For each platform, use web_fetch to search and assess presence:
...
1. web_fetch: `https://en.wikipedia.org/wiki/[Brand_Name]` — check if the page loads (not a redirect to search)
2. web_fetch: `https://en.wikipedia.org/wiki/[Founder_Name]` for founder article
