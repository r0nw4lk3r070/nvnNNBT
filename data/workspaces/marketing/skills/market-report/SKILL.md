...
- Triggered by `report` or `report <domain>`
...
- `MARKETING-AUDIT.md` -- from `audit`
- `LANDING-CRO.md` -- from `landing`
- `SEO-AUDIT.md` -- from `seo`
- `BRAND-VOICE.md` -- from `brand`
- `COMPETITOR-ANALYSIS.md` -- from `competitors`
- `FUNNEL-ANALYSIS.md` -- from `funnel`
- `CONTENT-AUDIT.md` -- from content analysis
- `AD-AUDIT.md` -- from `ads`
- `SOCIAL-AUDIT.md` -- from `social`
- `EMAIL-AUDIT.md` -- from `emails`
...
If competitor data is available from `competitors`, include:
