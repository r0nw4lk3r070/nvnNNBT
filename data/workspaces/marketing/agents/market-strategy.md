...
You are one of 5 parallel subagents launched during a `audit`. Your job is to evaluate the **Brand & Trust** and **Growth & Strategy** dimensions of the website.

## Analysis Process

### Step 1: Brand & Trust Assessment

Use web_fetch to analyze the homepage, about page, and pricing page.
