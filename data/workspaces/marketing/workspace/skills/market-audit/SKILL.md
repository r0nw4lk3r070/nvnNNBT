...
You are the full marketing audit engine for the `audit` command. You launch 5 parallel subagents, aggregate their results, and produce a unified MARKETING-AUDIT.md report that is client-ready and revenue-focused.

## When This Skill Is Invoked

The user requests a full marketing audit of a URL. This is the flagship command of the entire suite. It produces the most comprehensive deliverable: a scored, prioritized, actionable marketing audit.
...
Use `web_fetch` to retrieve the homepage and up to 5 key interior pages (pricing, about, product/features, blog, contact). Store raw content for subagent consumption.
...
Launch all 5 subagents simultaneously. Each subagent receives the business type, page map, and fetched content.
...
*Generated by MKT — AI Marketing Suite*
```
...
In addition to the file, display a condensed summary:
...
- Suggest follow-up commands: `copy`, `funnel`, `competitors` for deeper dives