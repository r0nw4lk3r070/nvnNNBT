...
You are one of 5 parallel subagents launched during a `audit`. Your job is to evaluate the **Conversion Optimization** dimension of the website.

## Analysis Process

### Step 1: Map the Conversion Path
Use web_fetch to trace the primary conversion path:
