...
- The legislation library is located at `workspace/library/` (full path: `E:\Art\skill-sets\nvnJRST\workspace\library\`)
- **Library structure**:
  - `workspace/library/eu-laws/EN/` — full text of EU regulations in English (PDF + .txt)
  - `workspace/library/eu-laws/NL/` — full text of EU regulations in Dutch (PDF + .txt)
  - `workspace/library/research/english/` — deep-dive analysis per regulation + sector guides (English)
  - `workspace/library/research/nederlands/` — deep-dive analysis per regulation + sector guides (Dutch)
